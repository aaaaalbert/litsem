...
\end{itemize}
\albert{Rewrite. Cycle between ``search'' and ``triage'' / ``refine'' and ``document'' and, zoom in \& out, branch off, ...}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{frame}
\albert{We don't talk about ``content quality'' (here) on purpose: this is hardest to assess, and we use paper metadata as a *quick* way to keep or discard material. Assessing paper quality *in depth* is a further topic.}
\note[itemize] {
